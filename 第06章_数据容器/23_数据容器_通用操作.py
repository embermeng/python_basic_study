...
# res4 = list({'tom': 75, 'jerry': 80}.items())
...
# res1 = dict({'tom': 75, 'jerry': 80})
# res2 = dict([('tom', 75), ('jerry', 80)])
# res3 = dict((('tom', 75), ('jerry', 80)))
# res4 = dict({('tom', 75), ('jerry', 80)})
# print(type(res1), res1)
# print(type(res2), res2)
# print(type(res3), res3)
# print(type(res4), res4)
...
print('lo' not in message)
print('上海' not in cities)
